...
public class WorldManager : MonoBehaviour
{
    ...
    public bool InitializeGame()
    {
        ...
        ServerGameManager.OnGameOver += OnGameOver;
        ServerGameManager.OnGameResult += OnGameResult;
    ...
    public void OnGameResult()
    {
        ...
        if (ServerGameManager.GetInstance().IsLobbyScene())
        {
    ...
    public void OnRecieve(MatchRelayEventArgs args)
    {
        ...
        switch (msg.type)
        {
            ...
            case Protocol.Type.GameStart:
                InGameUiManager.GetInstance().SetStartCount(0, false);
                ServerGameManager.GetInstance().ChangeState(ServerGameManager.GameState.InGame);
                break;
            case Protocol.Type.GameEnd:
                ...
                ServerGameManager.GetInstance().ChangeState(ServerGameManager.GameState.Over);
                break;
