...
public partial class BackEndMatchManager : MonoBehaviour
{
    ...
    private void GameSetup()
    {
        ...
        if (ServerGameManager.GetInstance().GetGameState() != ServerGameManager.GameState.Ready)
        {
            isHost = false;
            isSetHost = false;
            OnGameReady();
    ...
    public bool PrevGameMessage(byte[] BinaryUserData)
    {
        ...
        switch (msg.type)
        {
            ...
            case Protocol.Type.LoadGameScene:
                ServerGameManager.GetInstance().ChangeState(ServerGameManager.GameState.Start);
                return true;
        }
        return false;
    }
